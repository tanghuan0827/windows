...
public class ExcelUtil2 {
        ...
        while(rs.next()){
            ...
            for(int i=0;i<headers.length;i++){
                ...
                if (objVal instanceof Date) {
                    row.createCell(i).setCellValue(DateUtil2.formatDate((Date)objVal,"yyyy-MM-dd"));
                }else{
    ...
    public static Workbook fillExcelDataWithTemplate(ResultSet rs,String templateFileName)throws Exception{
        ...
        InputStream inp=ExcelUtil2.class.getResourceAsStream("/com/steadyjack/template/"+templateFileName);
    ...
    //主要处理double和integer之间不能相互转化的问题
    public static String formatCell4(String type2, HSSFCell cell) {
        if (cell == null) {
            return "";
        }
        switch (cell.getCellType()) {
        case HSSFCell.CELL_TYPE_NUMERIC:
            ...
            //主要处理double和integer之间不能相互转化的问题
            if(type2.equals("class java.lang.Integer")){
                String valueString =String.valueOf(cell.getNumericCellValue());
